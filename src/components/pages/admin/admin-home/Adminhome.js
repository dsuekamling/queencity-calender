      ...
      <section>
        <div className="split">
          <div className="split-text">
            ...
            <img className="adminhomeimg" src="https://fltmag.com/wp-content/uploads/2020/06/unnamed.png" alt="A park in Charlotte" />
          ...
          <div className="split-text">
            ...
            <img className="adminhomeimg" src="https://images.squarespace-cdn.com/content/v1/55b140cee4b0f7770edcc039/1489595202979-YNA956SH6P4GI7J44WXQ/hosting-a-live-event" alt="A park in Charlotte" />
